...
// import
// com.implementation.PollingApp.security.authObjects.CustomSessionAuthenticationObject;
...
// public ResponseEntity<ApiResponse<PollResponseDTO>> createPoll(@RequestBody
// PollEntryDTO pollEntryDTO) {
// CustomSessionAuthenticationObject authentication =
// (CustomSessionAuthenticationObject)
// SecurityContextHolder.getContext().getAuthentication();
// return ResponseEntity.ok(new
// ApiResponse<PollResponseDTO>(pollService.createPoll(pollEntryDTO,
// authentication.getUsername()), "Poll created successfully"));
// }
