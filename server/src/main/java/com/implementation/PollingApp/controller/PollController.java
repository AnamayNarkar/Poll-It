...
public class PollController {
        ...
        public ResponseEntity<ApiResponse<List<PollResponseDTO>>> getAllPollsFromUser() {
                return ResponseEntity.ok(new ApiResponse<List<PollResponseDTO>>(pollService.getAllPollsFromUser(((CustomSessionAuthenticationObject) SecurityContextHolder.getContext().getAuthentication()).getUsername()), "Polls fetched successfully"));
        }
