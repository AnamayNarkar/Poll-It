    ...
    return (
        <div className='loginFormContainer'>
            ...
            <form className='loginForm'>
                <input type='text' name='username' placeholder='Username' value={loginForm.username} onChange={handleInputChange} className='loginFormInput' maxLength='25' />
                <input type='password' name='password' placeholder='Password' value={loginForm.password} onChange={handleInputChange} className='loginFormInput' maxLength='25' />
