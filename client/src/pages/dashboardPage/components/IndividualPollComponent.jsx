    ...
    return (
        <div className="individualPollContainer">
            ...
            <div className='bottomBarInPollComponent'>
                ...
                <div className="bottomBarComponent commentsIconParentDiv" style={{ cursor: 'pointer', gap: '5px', color: 'white', fontSize: '1.2rem', fontFamily: "'Lato', sans-serif" }} onClick={() => { navigate(`/poll/${poll.id}`) }} >
                ...
                <div className="bottomBarComponent shareIconParentDiv" style={{ cursor: 'pointer', borderBottomRightRadius: '10px' }} onClick={() => { navigator.clipboard.writeText(`http://localhost:5173/poll/${poll.id}`); window.alert('Link copied to clipboard!') }}>
